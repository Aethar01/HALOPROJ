...
def Grylls19(z,Mh,sigm):
    ...
    #Mhv=Mh
    Mss=np.log10(2.)+np.log10(N)+Mh-np.log10(10.**(-beta*(Mh-M1))+10.**(gamma*(Mh-M1)))+np.random.normal(0.,sigm,len(Mh))
...
def Shankar17(Mh,sigm):
    ...
    Mss=Ms0+alpha*np.log10(10.**(Mh-Mh0))-np.log10(1.+10.**(beta*(Mh-Mh0)))+np.random.normal(0.,sigm,len(Mh))
